...
def connect_to_mongo(mongo_client):
    ...
    MODEL_INFO = utils.access_model_by_name(CONFIG, model)


def disconnect_to_mongo():
    utils.disconnect_from_mongo()
...
def find_provenance_similarity(dsir_1, dsir_2, temporal_context, mongo_client):
    """
