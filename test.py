...
def main():
    ...
    # model_graph = ModelGraph(mongo_client, graph_client, ObjectId("5f7ca92542352d69d36780ac"))
    # model_graph.delete_graph()
    # print(model_graph.generate_model_graph())
    # model_graph.generate_window_number()
    timeline = Timelines(mongo_client, graph_client, ObjectId("5f7ca92542352d69d36780ac"))
    # timeline.get_top_k_timelines_test(10)
    timelines = timeline.get_top_k_timelines(2)
    print(timelines[0])
    print("\n")
    print(timelines[1])
